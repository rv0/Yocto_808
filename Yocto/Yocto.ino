...
byte sync_mode = MASTER; // Holds the current sync mode.
byte sync_fallback = MASTER; // Stores the sync mode so we can fallback to it later.
...
#define TEMPO_COEFF 2500000 // This will give 24ppqn;
